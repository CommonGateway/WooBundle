...
use CommonGateway\WOOBundle\Service\NotificationService;
 ...
 */
class ZaaksysteemNotificationHandler implements ActionHandlerInterface
{
    ...
    {
        return $this->service->zaaksysteemNotificationHandler($data, $configuration);
